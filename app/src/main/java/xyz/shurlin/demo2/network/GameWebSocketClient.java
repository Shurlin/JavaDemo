...
public class GameWebSocketClient {
    ...
    private final JsonAdapter<GameEnd> gameEndAdapter = moshi.adapter(GameEnd.class);
    ...
    private final WebSocketListener listener = new WebSocketListener() {
        ...
        public void onMessage(@NonNull WebSocket webSocket, @NonNull String text) {
            ...
            switch (type) {
                ...
                case "GAME_END":
                    try {
                        GameEnd gameEnd = gameEndAdapter.fromJson(text);
                        if (gameEnd != null) {
                            Log.i(TAG, "ws game end: " + gameEnd.winner);
                            if (callback != null) main.post(() -> callback.onGameEnd(gameEnd));
                            return;
                        }
                    } catch (Exception ignored) {
                    }
